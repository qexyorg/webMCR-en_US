    ...
    public function ShowNewsEditor()
    {
        ...
        if ($editCategory !== false and $editTitle !== false and $editMessage !== false) {
            ...
            if (!$editCategory or !$editMessage or !$editTitle)
                $text_str = 'You need fill required fields.';
                ...
                if ($editMode > 0) {
                    ...
                    if ($news_item->Edit(
                        ...
                        $state = 'success';
                        $text_str = 'News successfully saved';
                    } else
                        $text_str = 'Access denied';
                    ...
                    $state = 'success';
                    $text_str = 'News successfully added';
                }
            }
