...
class Message
{
    ...
    public static function BBDecode($text)
    {
        ...
        while (strcmp($text = preg_replace("/\[quote=(?:$quote)(.*)(?:$quote)\](.+?)\[\/quote\]/Uis", "<div class=\"comment-quote\"><div class=\"comment-quote-a\">\\1 said:</div><div class=\"comment-quote-c\">\\2</div></div>", $tmp), $tmp) != 0)
            $tmp = $text;
